            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 mt-1 text-sm">Manage permissions for the {role?.name} role</p>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        <SingleSelectField
                          ...
                          isDisabled={false}
                          isLoading={false} // you can connect this to your loading state if needed
                          isClearable={true}
                        />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <SingleSelectField
                          value={selectedMenu}
                          onChange={(val) => setSelectedMenu(val)}
                          options={menuOptions.map((menu) => ({ value: menu, label: menu }))}
                          placeholder="Select Menu"
                          isDisabled={!selectedModule} // disable if no module selected
                          // isLoading={loadingMenus}    // optional: connect to your loading state
                          isClearable={true}
                        />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <SingleSelectField
                          ...
                          onChange={(val) => setSelectedSubMenu(val)}
                          options={[
                            { value: "", label: "All Submenus" }, // default option
                          ...
                          isDisabled={!selectedMenu} // disable if no menu selected
                          isClearable={true}
                        // isLoading={loadingSubMenus} // optional: connect to your loading state
                        />
                      </div>
                    </div>
                  </div>
