...
export default function ReceivedInformation({ formData, supplierInfo, onInputChange }: ReceivedInformationProps) {
  ...
  return (
    <fieldset className="border p-4">
      <legend className="font-bold">Received Information</legend>
          ...
          <tr>
            ...
            <td className="py-1">
              <input
                ...
                readOnly
                className="w-full p-1 border rounded text-sm bg-gray-100 text-right font-bold text-green-600"
              />
            </td>
          </tr>
          <tr>
